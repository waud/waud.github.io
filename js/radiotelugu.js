...
var RadioTelugu = function() {
	...
	this.spicefm = window.document.getElementById("spicefm");
	this.radio9 = window.document.getElementById("radio9");
	this.radiogeetam = window.document.getElementById("radiogeetam");
	this.mastitime = window.document.getElementById("mastitime");
	this.adhurs.onclick = function() {
		_g.playRadio("adhurs");
	};
	this.spicefm.onclick = function() {
		_g.playRadio("spicefm");
	};
	this.radio9.onclick = function() {
		_g.playRadio("radio9");
	};
	this.radiogeetam.onclick = function() {
		_g.playRadio("radiogeetam");
	};
	this.mastitime.onclick = function() {
		_g.playRadio("mastitime");
	};
	this.title.innerText = "WAUD RADIO TELUGU";
	this.stations = new haxe_ds_StringMap();
	this.stations.set("adhurs","http://stream.radiojar.com/265xy1sdxwwtv");
	this.stations.set("spicefm","http://fmout.spicefm.in:8000/spice_b");
	this.stations.set("radio9","http://174.37.252.208:8530/;stream.mp3");
	this.stations.set("radiogeetam","http://149.56.175.167:5700/stream");
	this.stations.set("mastitime","http://ice41.securenetsystems.net/DPMASTI?type=.mp3");
	this.labels = new haxe_ds_StringMap();
	this.labels.set("adhurs","Radio Adhurs");
	this.labels.set("spicefm","Spice FM");
	this.labels.set("radio9","Radio 9");
	this.labels.set("radiogeetam","Radio Geetam");
	this.labels.set("mastitime","Masti Time");
};
...
RadioTelugu.prototype = {
	playRadio: function(station) {
		if(this.snd != null) this.snd.destroy();
		this.snd = new WaudSound(this.stations.get(station),{ autoplay : true, webaudio : false});
		this.playing.innerText = this.labels.get(station);
	}
