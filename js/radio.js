...
var Radio = function() {
	...
	this.heart = window.document.getElementById("heart");
	this.lbc = window.document.getElementById("lbc");
	this.smooth = window.document.getElementById("smooth");
	this.radiox.onclick = function() {
		_g.playRadio("radiox");
	};
	this.capital.onclick = function() {
		_g.playRadio("capital");
	};
	...
	this.stations.set("radiox","http://ice-sov.musicradio.com/RadioXUKMP3");
	this.stations.set("capital","http://ice-sov.musicradio.com/CapitalUK");
	this.stations.set("heart","http://ice-sov.musicradio.com/HeartUKMP3");
	this.stations.set("lbc","http://ice-sov.musicradio.com/LBCUKMP3");
	this.stations.set("smooth","http://ice-sov.musicradio.com/SmoothUKMP3");
	this.labels = new haxe_ds_StringMap();
	this.labels.set("radiox","Radio X UK");
	this.labels.set("capital","Capital UK");
	this.labels.set("heart","Heart UK");
	this.labels.set("lbc","LBC UK");
	this.labels.set("smooth","Smooth UK");
};
Radio.__name__ = true;
Radio.main = function() {
	new Radio();
