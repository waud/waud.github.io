...
var Sample3 = function() {
	...
	this._addButton("Spin Sound 1",0,100,80,30,function() {
		_g._snd1.play();
	});
	this._addButton("Spin Sound 2",80,100,80,30,function() {
		_g._snd2.play();
	});
	this._addButton("Spin Sound 3",160,100,80,30,function() {
		_g._snd3.play();
	});
	this._addButton("Spin Sound 4",240,100,80,30,function() {
		_g._snd4.play();
	});
	this._addButton("Spin Sound 5",320,100,80,30,function() {
		_g._snd5.play();
	});
	this._addButton("Hit Bonus",400,100,80,30,function() {
		_g._snd6.play();
	});
	Waud.init();
	Waud.autoMute();
	...
	this._snd1 = new WaudSound("sounds/spin_1.m4a");
	this._snd2 = new WaudSound("sounds/sun_spin2.m4a");
	this._snd3 = new WaudSound("sounds/Sun_spin_4.m4a");
	this._snd4 = new WaudSound("sounds/sun_spin_5.m4a");
	this._snd5 = new WaudSound("sounds/sun_spin_6.m4a");
	this._snd6 = new WaudSound("sounds/sun_win_during_free_spin.m4a");
	this._resize();
};
Sample3.__name__ = true;
Sample3.main = function() {
	new Sample3();
};
Sample3.__super__ = pixi_plugins_app_Application;
Sample3.prototype = $extend(pixi_plugins_app_Application.prototype,{
